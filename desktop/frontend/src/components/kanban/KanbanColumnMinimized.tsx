...
export function KanbanColumnMinimized({
  ...
  return (
    ...
    >
      ...
      {columnUnreadCount > 0 && (
        <div className="h-4.5 min-w-4.5 px-1.5 flex items-center justify-center rounded-full bg-unread-bg text-unread-text text-[0.625rem] font-semibold leading-none shrink-0">
          {columnUnreadCount}
        </div>
      )}
